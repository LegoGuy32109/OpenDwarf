...
echo Optimizing wasm for runtime performance;
wasm-opt -O4 --strip-debug static/game/open_dwarf_lib_bg.wasm -o static/game/opt_open_dwarf_lib.wasm --enable-threads --enable-bulk-memory --enable-bulk-memory-opt --enable-sign-ext --enable-nontrapping-float-to-int;
...
echo Done 😎;
notify-send -i "$HOME/Projects/OpenDwarf/game_library/assets/sprites/Dwarf.png" "OpenDwarf" "web-release complete";
