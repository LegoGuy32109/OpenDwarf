...
import { FLOOR_FRAME_COUNT, GLOBALS_UNIFORMS } from "./_chunks.ts";

export const FLOOR_STRIDE_FLOATS = 7;
...
export const sampler = TEXTURE_UNITS.floor;
...
const float FRAME_H = 1.0 / ${FLOOR_FRAME_COUNT.toFixed(1)};
