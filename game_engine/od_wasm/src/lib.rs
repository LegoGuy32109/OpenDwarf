...
use od_core::{
  DrawCmd, GlyphInstance, RectInstance, DRAWCMD_PROGRAM_RECT,
  DRAWCMD_PROGRAM_TEXT, DRAWCMD_SIZE_BYTES, GLYPH_INSTANCE_STRIDE_BYTES,
  GLYPH_INSTANCE_STRIDE_FLOATS, RECT_INSTANCE_STRIDE_BYTES,
