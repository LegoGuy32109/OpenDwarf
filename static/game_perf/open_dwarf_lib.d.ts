...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_74603: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_71219: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_66021: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_520: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4061: (a: number, b: number) => void;
