...
export interface InitOutput {
  ...
  readonly main: () => void;
  readonly __wasm_bindgen_func_elem_67664: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_70890: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_61986: (a: number, b: number, c: number, d: number) => void;
