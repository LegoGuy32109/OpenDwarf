...
fn spawn_empty_tilemap_chunk(
    ...
    shadow_atlas: &super::visuals::EdgeShadowAtlas,
    obscure_atlas: &super::visuals::CeilingShadowAtlas,
    fog_atlas: &super::visuals::FogShadowAtlas,
) {
